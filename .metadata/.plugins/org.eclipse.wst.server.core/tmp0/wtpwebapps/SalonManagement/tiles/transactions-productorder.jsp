            ...
            <div class="row ">
                <div class="col s3" ng-repeat="product in productList">
                    ...
                    <div class="card-content">
                      ...
                      <h5 class="light">{{product.strProductName}}</h5>
                      <p>{{product.dblProductPrice | currency:"Php"}}</p>
                    </div>
                    <div class="card-reveal">

                    <span class="card-title grey-text text-darken-4"><i class="material-icons right">close</i></span>
                    <h4 class="light">{{product.strProductName}}<span class="thin"> -  {{product.dblProductPrice | currency:"Php"}}</span> </h4>
                        <div class="input-field col s12">
                            <input type="number" id="crOrderContact" ng-model = "details.quantity"/>
                            <label for="crOrderContact"><b>Quantity</b><i
                                    class="material-icons red-text tiny">error_outline</i></label>
                        </div>
                        <h6>{{product.dblProductPrice * details.quantity | currency: "Php"}}</h6>
                        
                        <button class="waves-effect waves-light btn" ng-click="addToCart($index); calculateTotal()"><i class="material-icons left">shopping_basket</i>BUY NOW!</button>
                    </div>
                </div>
                </div>
