/**
 * Created by Castillo on 10/20/2016.
 */
/**
...
(function () {
    ...
    angular
        .module('app')
        .controller('serviceAvailments', serviceAvailments);

    function serviceAvailments($scope, $http, $filter, reportsFactory) {
        var vm = this;
        ...
        function searchReport (datFrom, datTo) {
            ...
            $http({
                method: 'post',
                url: 'getServiceAvailed',
                data: dat,
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                }
            }).then(function successCallback(data) {
                vm.sa = data.data.services;
                vm.searchRep = 1;
                vm.datFrom = '';
                vm.datTo = '';
