...
(function () {
    ...
    angular
        .module('app')
        .controller('cancelledReservationController', cancelledReservationController);

    function cancelledReservationController($scope, $http, $filter, reportsFactory) {
        var vm = this;
        ...
        function searchReport (datFrom, datTo) {
            ...
            $http({
                method: 'post',
                url: 'getCancelledReservations',
                data: dat,
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                }
            }).then(function successCallback(data) {
                vm.cr = data.data.reservations;
                vm.searchRep = 1;
                vm.datFrom = '';
                vm.datTo = '';
