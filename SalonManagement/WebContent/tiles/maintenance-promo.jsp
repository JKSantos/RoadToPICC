        ...
        <div class="wrapper">
            ...
            <div class="main z-depth-barts" style="margin-left: 20px; margin-right: 20px;">
                <div class="col s12" style="margin-left: 20px; margin-right: 20px;">
                    ...
                    <a class="waves-effect waves-light modal-trigger btn-flat purple darken-2 darken-3 left white-text"
                       href="#create" style="margin-top: 50px; margin-left: 15px;">CREATE</a>
                        ...
                        <c:forEach items="${promoList}" var="promo">
                            <tr>
                                <td style="padding:0; margin:0;">
                                    <center>${promo.strPromoName}</center>
                                </td>
                                <td style="padding:0; margin:0;">
                                    <center>Php ${promo.dblPromoPrice}</center>
                                </td>
                                <td style="padding:0; margin:0;">
                                    <center>${promo.strPromoAvailability}</center>
                                </td>
                                <td class="center" style="padding:0; margin:0;">
                                    <button data-target="viewProdSvc${promo.intPromoID}"
                                            class="waves-effect waves-purple modal-view btn-flat transparent"
                                ...
                                <div class="aside aside1 z-depth-barts" style="padding: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="input-field col s6">
                                            <p class="center">
                                                <input type="checkbox" class="filled-in nonexpiry filltwo" id="unli"
                                                       name="strNonExp">
                                                <label for="unli">Non-Expiry</label>
                                            </p>
                                        </div>
                                        <div class="input-field col s6">
                                            <input name="strExp" type="date" class="datepicker-promo expiration filltwo"
                                                   id="promoend" placeholder="Expiration"/>
                                        </div>
                                        <div class="input-field col s12">
                                            <input name="strPromoName" type="text" class="validate specialname noSpace"
                                                   id="promoname" required placeholder="Promo Name">
                                            <label for="promoname" class="active">Promo Name<span
                                                    class="red-text">*</span></label>
                                        </div>
                                        <div class="input-field col s12">
                                            <textarea name="strPromoDesc" id="promodetails"
...
*Sample Guideline 3"></textarea>
                                        ...
                                        <div class="input-field col s5">
                                            <p class="center">
                                                <input name="strFree" type="checkbox" class="filled-in free fillone"
                                                       id="free"/>
                                        ...
                                        <div class="input-field col s6 offset-s1">
                                            <input name="dblPromoPrice" type="text"
                                                   class="validate right-align price amountFormat noSpace fillone"
                                                   id="promoprice" maxlength="8" placeholder="Amount">
                                                    ...
                                                    <div class="highlight centered responsive-table">
                                                        <table class="centered striped services">
                                                            ...
                                                            <c:forEach items="${serviceList}" var="service">
                                                                <tr>
                                                                    <td><input type="checkbox" name="servicePromoSelect"
                                                                    ...
                                                                    <td><input type="number" name="servicePromoQty"
                                                                               style="width: 75px" min="1" max="99"
                                                                               value="1"></td>
                                                                </tr>
                                                            </c:forEach>
                                                        </table>
                                                    ...
                                                    <div class="highlight centered responsive-table">
                                                        <table class="centered striped services">
                                                            ...
                                                            <c:forEach items="${productList}" var="products">
                                                                <tr>
                                                                    <td><input type="checkbox" name="productPromoSelect"
                                                                               id="prodCheck${products.intProductID}"
                                                                               value="${products.intProductID}"><label
                                                                            for="prodCheck${products.intProductID}"></label>
                                                                    </td>
                                                                    <td>${products.strProductName}</td>
                                                                    <td>${products.dblProductPrice}</td>
                                                                    <td><input type="number" name="productPromoQty"
                                                                               style="width: 75px" min="1" max="99"
                                                                               value="1"></td>
                                                                </tr>
                                                            </c:forEach>
                                                    ...
                                                    <div class="highlight centered responsive-table">
                                                        <table class="centered striped services">
                                                            ...
                                                            <c:forEach items="${packageList}" var="pack">
                                                                <tr>
                                                                    <td><input type="checkbox" name="packagePromoSelect"
                                                                               id="promoPack${pack.intPackageID}"
                                                                               value="${pack.intPackageID}"><label
                                                                            for="promoPack${pack.intPackageID}"></label>
                                                                    </td>
                                                                    <td>${pack.strPackageName}</td>
                                                                    <td>${pack.dblPackagePrice}</td>
                                                                    <td><input type="number" name="packagePromoQty"
                                                                               style="width: 75px" min="1" max="99"
                                                                               value="1"></td>
                                                                </tr>
                                                            </c:forEach>
