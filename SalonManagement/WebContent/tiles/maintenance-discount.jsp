        ...
        <div class="col s12" style="margin-left: 20px; margin-right: 20px;">
                ...
                <div class="nav-wrapper col s4">
                    <form>
                        <div class="input-field">
                            <input id="discountSearch" placeholder="Search" class="grey-text text-darken-4" type="search" required>
            ...
            <table id="discounttbl"
                ...
                <tr>
                    ...
                    <th class="dt-head-right prodPrice">Price</th>
                ...
                <c:forEach items="${discountList}" var="discount">
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px; margin:0;" class="dt-body-left">${discount.strDiscountDetails}</td>
