...
public class UpdateOrderAction {
	...
	//status if failed or success ang update;
	...
	public String execute() throws Exception{
		...
		ProductSales sales = new ProductSales(this.intOrderID, DateHelper.parseDate("2016-03-04"),DateHelper.parseDate("2016-03-04"), type, strName, strStreet, intLocationID, strContactNo, productList, invoice, "REQUEST");

		boolean result = salesService.updateProductSales(sales);
