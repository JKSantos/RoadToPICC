	...
	public List<ProductOrder> getAllProductOrder(int ReservationID) {
		...
		try{
			...
			while(products.next()){
				...
				this.productList.add(ItemDiscount.getProductDiscount(order));
			}
	...
	public List<ReservedService> getAllReservedService(int ReservationID) {
		...
		try{
			...
			while(services.next()){
				...
				this.serviceList.add(ItemDiscount.getServiceDiscount(reserve));
			}
	...
	public List<ReservedPromo> getAllReservedPromo(int ReservationID) {
		...
		try{
			...
			while(promos.next()){
				...
				this.promoList.add(ItemDiscount.getPromoReservation(promo));
			}
