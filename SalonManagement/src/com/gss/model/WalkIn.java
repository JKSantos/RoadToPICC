...
public class WalkIn {
	...
	public WalkIn(int intWalkInID, String strName, String strContactNo, List<ServiceWalkIn> services, List<ProductWalkIn> products, List<PackageWalkIn> packages, List<PromoWalkIn> promo, Invoice invoice, Payment payment, String strWalkInStatus, String strPaymentStatus){
