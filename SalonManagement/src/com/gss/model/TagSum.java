...
public class TagSum {
	...
	public TagSum(int intProductID, String strProductName, int intQuantity, int intDefective, int intLost,
			int intExpired, int intConsumed) {
		super();
	...
	public static List<TagSum> getTagSum(){
		ProductTags tags = new ProductTagImpl();
		
		return tags.getTagSum();
	}
}
